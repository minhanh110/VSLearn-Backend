...
@Setter
@Entity
@Table(name = "notify", indexes = {
        @Index(name = "idx_notify_to_user", columnList = "to_user_id"),
        @Index(name = "idx_notify_is_send", columnList = "is_send"),
        @Index(name = "idx_notify_created_at", columnList = "created_at")
})
public class Notify {
    @Id
